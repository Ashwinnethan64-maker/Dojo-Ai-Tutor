...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        // Provide friendly message if keys are placeholder
        ...
        <Card className="p-6 shadow-md border-zinc-200 dark:border-zinc-800">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-[10px] uppercase">
              <span className="bg-white dark:bg-[#121215] px-2 text-zinc-400">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full text-xs py-2.5 gap-2 border-zinc-200 dark:border-zinc-700"
          >
